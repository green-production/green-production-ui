...
export const Watson_URL = `https://.eu-gb.discovery.watson.cloud.ibm.com/instances/e58f4c75-a324-40d1-9fc9-6f5f99b03d81/v1/environments/${process.env.REACT_APP_ENVIRONMENT_ID}/collections/${process.env.REACT_APP_COLLECTION_ID}/query?version=2019-04-30&query=`;
